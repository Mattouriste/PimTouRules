...
This Terms of Service Agreement (the "Agreement") is entered into between Mattouriste ("Bot Owner"), Atarka ("Bot Owner") and the user ("User") of the Pim Tou Discord bot (the "Bot").
